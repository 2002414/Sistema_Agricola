...
if(isset($_SESSION['id_usuario'])){
    ...
    $resultadoNotificaciones = pg_query_params(
        $conn,
        $queryNotificaciones,
        array($_SESSION['id_usuario'])
    );
    ...
    if($resultadoNotificaciones){
        ...
        $filaNotificaciones = pg_fetch_assoc(
            $resultadoNotificaciones
        );

        $notificacionesSinLeer =
            $filaNotificaciones['total'];
...
<div class="Menu">
   ...
   <a href="Modules/Notificaciones/Listar_Notificaciones.php">
...
<a href="Modules/Productores/Listar_Solicitudes.php">
...
<a href="Modules/Usuarios/Crear_Administrador.php">
...
<div class="alert alert-info mt-3">
    ...
    <strong>
        ...
        <?php echo $notificacionesSinLeer; ?>
    ...
    <div class="col-md-3">
        ...
        <div class="card shadow border-0">
            ...
            <div class="card-body text-center">
                ...
                <i class="fa-solid fa-file-circle-check fs-1 text-primary"></i>
